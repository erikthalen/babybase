...
const _heroCopied = ref(false);

function copyHeroCmd() {
  navigator.clipboard.writeText("npx babybase demo");
  _heroCopied.value = true;
  setTimeout(() => (_heroCopied.value = false), 1500);
}
    ...
    <section class="pb-hero">
      ...
      <div class="pb-container">
        <div class="pb-hero-content">
          ...
          <div class="pb-terminal hero-terminal" style="width: 100%; position: relative;">
            <pre
              class="pb-terminal-body"><span class="t-prompt">$ </span><span class="t-cmd">npx babybase</span><span class="t-arg"> demo</span></pre>
            <button
              class="pb-copy-btn"
              :class="{ 'is-copied': _heroCopied }"
              @click="copyHeroCmd"
              aria-label="Copy command to clipboard"
              title="Copy to clipboard"
            >
              <svg v-if="!_heroCopied" xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<span class="t-dim">  Server started on port </span><span class="t-url">1234</span><span class="t-dim">.</span>
<span class="t-dim">  Browse your database at </span><span class="t-url">http://localhost:1234</span>
...
<span class="e-f">serve</span>(app)</pre>
    ...
    <!-- ── Open source ───────────────────────────────── -->
    <section class="pb-oss">
      <div class="pb-container">
        <div class="pb-oss-card">
          <div class="pb-oss-bg" aria-hidden="true"></div>
          <div class="pb-oss-content">
            <span class="pb-oss-eyebrow">Free &amp; open source</span>
            <h2 class="pb-oss-heading">Built in the open.</h2>
            <p class="pb-oss-desc">
              Babybase is MIT-licensed and developed entirely in public.
              Read the source, report issues, or contribute — all on GitHub.
            </p>
            <a class="pb-oss-cta" href="https://github.com/erikthalen/babybase" target="_blank" rel="noopener noreferrer">
    ...
    <footer class="pb-footer">
      <div class="pb-container">
        <div class="pb-footer-inner">
          <p class="pb-footer-copy">© {{ new Date().getFullYear() }} babybase — MIT License</p>
          <nav class="pb-footer-links" aria-label="Footer links">
            <a href="https://github.com/erikthalen/babybase" target="_blank" rel="noopener noreferrer">GitHub</a>
            <a href="https://www.npmjs.com/package/babybase" target="_blank" rel="noopener noreferrer">npm</a>
          </nav>
        </div>
      </div>
    </footer>
...
.hero-terminal:hover .pb-copy-btn {
  opacity: 1;
}
...
.pb-oss-bg {
  ...
  inset: 0;
  background:
    radial-gradient(ellipse 70% 80% at 50% 110%, rgba(45, 212, 191, 0.1) 0%, transparent 70%),
    var(--bg-card);
}
