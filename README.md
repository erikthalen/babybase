...
<p align="center">
  ...
  <img src="https://img.shields.io/npm/v/@babybase/core?style=flat-square" alt="Version" />
</p>
...
Want to try it without a database file?

```sh
npx babybase demo
```

Opens a bundled sample database in a temporary directory. Nothing is written to your project and changes don't persist — safe to poke around.
